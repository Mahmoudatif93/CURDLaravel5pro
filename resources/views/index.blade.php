...
<div class="row">
	<div class="col-md-6">
		<h2>CRUD Laravel 5.5 </h2>
	</div>
	<div class="col-md-4">
		<form action="/search" method="get">
			<div class="input-group">
				<input id="search" type="search" name="search" name="form-control">
...
<form  method="post">
	{{ csrf_field() }}
	 {{method_field('DELETE')}}
	 <button formaction="{{action('PostController@deleteall')}}" type="submit" class="btn btn-danger">Delete All Selected</button>
