    ...
    */
    ...
    public function verification($token){
        ...
        if(isset($verify)){
            ...
            return redirect('/login')->with('warning','Sorry your email cannot idetified');
    ...
    protected function registered(Request $request ,$user){
        $this->guard()->logout();
        return redirect('/login')->with('success','we sent to you an activation code. check your email and click on the link to verify.');
    }
}
