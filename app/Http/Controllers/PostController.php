...
class PostController extends Controller
{
    ...
    public function search(Request $request){
        ...
        $posts=DB::table('posts')->where('name','like','%'.$search.'%')->paginate(4);
        return view('index',['posts'=>$posts]);
    ...
    public function store(Request $request)
    {
        ...
        if($posts){
            $red=redirect('posts')->with('success','Data has been addes');
        }else{
            $red=redirect('posts/create')->with('dinger','Input Data failled,please try again');
        }
        return $red;
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($posts){
            ...
            $red=redirect('posts/edit/'.$id)->with('danger','error update , tray again');
        }
        return $red;
